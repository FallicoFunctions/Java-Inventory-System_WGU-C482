...
/** This class is the add product controller class. It handles adding new products to the inventory system.
 <p><b>
 This is where I will answer the requirement about a bug in my code and how I fixed it: When I first wrote the code for
 this class I forgot to add "implements Initializable" as we see below in the class declaration. Because of this
 the associated parts were not displaying in the parts tables. After I added "implements Initializable" top associated
 parts table was working fine but the bottom was not. I noticed I had another bug. I had typos in the column titles
 I was setting. Because of the typos the column headers, and the data belonging to those columns, were not displaying.
 Once I fixed the typos of the column headers, the bottom table worked as intended.
 </b></p>
 */
public class AddProductController implements Initializable {
     ...
     */
    public void onMouseSave(MouseEvent mouseEvent) {
        ...
        if (errProductField.length() > 0){ //Check if text fields are empty and give error message if they are
            ...
            try {
                ...
                if (errProductValid.length() > 0) { //Checks text field validation and give error messages if criteria not met
                    ...
                    Product addProduct = new Product(productID, name, price, inv, min, max); //Add new product
                    Inventory.addProduct(addProduct);
                    addProduct.setAssociatedPartsList(associatedParts); //Add associated parts to new product
